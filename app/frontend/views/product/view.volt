							...
							<div class="pb-left-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<div id="image-block" class="clearfix">
                                    <span id="view_full_size">
                                        <a class="jqzoom" title="" rel="gal1" href="{{ product.getFirstImage().src }}"
                                           itemprop="url" data-rel="prettyPhoto">
	                                        <img src="{{ product.getFirstImage().src }}" itemprop="image">
                                        </a>
                                    </span>
									<a href="{{ product.getFirstImage().src }}" data-rel="prettyPhoto"
									   class="zoomImg"><i class="fa fa-search"></i></a>
								</div>
								<!-- end image-block -->
												...
												<div class="price">
													<p class="our_price_display" itemprop="offers" itemscope=""
													   itemtype="http://schema.org/Offer">
														...
														<span id="our_price_display2"
														      itemprop="price">{{ currencyObj.symbol }} {{ getPrice(product.price, currencyObj) }}</span>
														<meta itemprop="priceCurrency"
														      content="{{ currencyObj.title }}">
													</p>
													<p itemprop="price" class="our_price_display inverse-currency"
												...
												<div class="box-cart-bottom" style="margin-left: 5px;">
													<div>
														<p class="buttons_bottom_block no-print">
															<button type="button" name="" class="button exclusive"
															        title="Добавить в корзину"
															        onclick="cartAdd({{ product.id }})">
																<span><i class="fa fa-shopping-cart"
																         style="font-size: 2em;width: 30px;"></i> Добавить в корзину</span>
															</button>
														</p>
													</div>
												</div>
