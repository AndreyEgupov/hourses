    ...
    <div class="block_content">
        <form action="" method="get">
            <div>
                <div class="layered_price" >
                    <div class="layered_subtitle_heading">
                        ...
                        <span id="layered_price_range"><i>$</i><spn>16.00</spn> - <i>$</i><spn>83.00</spn></span>
                ...
                <div class="layered_filter">
                    ...
                    <ul  class="col-lg-12">
                        <li class="nomargin hiddable col-lg-6">
                            <input type="checkbox" class="checkbox" name="attribute[]" value="1" />
                            <input type="checkbox" class="checkbox" name="attribute[]" value="2" />
                            <label >
            ...
            <div class="col-sm-12" style="text-align: right; padding-right: 0;">
                <a href='{{ router.getRewriteUri() }}' role="btn" class="btn btn-default" style="margin-right: 7px;" >Отменить</a>
